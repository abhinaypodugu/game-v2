// Server entrypoint: Express + Socket.io adapter around @catan/host, plus the
// JSONL log and idle sweeper. In production it also serves the built client
// (client/dist) so the whole game deploys as one Node service with one URL.
